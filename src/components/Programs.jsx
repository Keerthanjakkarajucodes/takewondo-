...
const PROGRAMS = [
  {
    ...
    desc: 'Kukkiwon-certified training in kicks, forms and sparring under national-level coaches.',
    tag: 'ALL AGES',
    img: imgTKD,
  },
  {
    ...
    desc: 'High-intensity punches and kicks. Build explosive power, cardio and confidence every session.',
    tag: 'ADULTS',
    img: imgKick,
  },
  {
    ...
    desc: 'Stand-up striking meets ground control. A complete combat programme for athletes ready to compete.',
    tag: 'ADVANCED',
    img: imgMMA,
  },
  {
    ...
    desc: 'Practical escapes and response drills. Designed for all levels — no prior experience needed.',
    tag: 'ALL AGES',
    img: imgSD,
  },
];
